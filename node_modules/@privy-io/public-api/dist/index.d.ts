...
export const CoinbaseOnRampInitInput: z.ZodUnion<[z.ZodObject<{
    ...
    assets: z.ZodOptional<z.ZodArray<z.ZodEffects<z.ZodEnum<["SOL"]>, string, "SOL">, "many">>;
}, "strip", z.ZodTypeAny, {
    addresses: {
        address: string;
        blockchains: ("solana" | "ethereum" | "bitcoin" | "base" | "avacchain" | "optimism" | "polygon" | "arbitrum" | "stellar")[];
...
export const SUPPORTED_SMART_WALLET_TYPES: readonly ["safe", "kernel", "biconomy", "light_account"];
export type SmartWalletType = (typeof SUPPORTED_SMART_WALLET_TYPES)[number];
export const SmartWalletProvider: z.ZodEnum<["safe", "kernel", "biconomy", "light_account"]>;
export const SmartWalletNetworkConfigurationSchema: z.ZodObject<{
...
export const SmartWalletConfigurationSchema: z.ZodDiscriminatedUnion<"enabled", [z.ZodObject<{
    ...
    smart_wallet_type: z.ZodEnum<["safe", "kernel", "biconomy", "light_account"]>;
...
export const EthereumIdTokenEntry: z.ZodObject<z.objectUtil.extendShape<Pick<{
    type: z.ZodLiteral<"wallet">;
    address: z.ZodString;
    chain_id: z.ZodOptional<z.ZodString>;
    chain_type: z.ZodLiteral<"ethereum">;
...
export const EthereumEmbeddedWalletIdTokenEntry: z.ZodObject<z.objectUtil.extendShape<Pick<{
    type: z.ZodLiteral<"wallet">;
    address: z.ZodString;
    imported: z.ZodDefault<z.ZodBoolean>;
    wallet_index: z.ZodNumber;
...
export const SolanaEmbeddedWalletIdTokenEntry: z.ZodObject<z.objectUtil.extendShape<Pick<{
    type: z.ZodLiteral<"wallet">;
    address: z.ZodString;
    public_key: z.ZodString;
    chain_type: z.ZodLiteral<"solana">;
...
export const DelegatedActionsRpcInput: z.ZodObject<{
    address: z.ZodString;
    chain_type: z.ZodUnion<[z.ZodLiteral<"solana">, z.ZodLiteral<"ethereum">]>;
...
export type DelegatedActionsRpcInput = z.infer<typeof DelegatedActionsRpcInput>;
