    ...
    plugins: [
        ...
        viteStaticCopy({
            targets: [
                ...
                // Adjust the target to copy the youtubePlayerHook.js file
                {
                    src: './src/scripts/content/youtubePlayerHook.js',
                    dest: './scripts/content', // Destination in the dist folder
                    // Specify overwrite option
                    overwrite: true // This ensures existing files are not deleted
                },
